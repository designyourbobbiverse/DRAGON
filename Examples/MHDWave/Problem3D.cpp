...
void Problem::problemComplete(Grid& problem, double t){
    ...
    //std::cout<<"density error: "<<L1.rho<<"\n";
    //std::cout<<"momentum error: "<<std::sqrt(L1.mom*L1.mom)<<"\n";
    //std::cout<<"energy error: "<<L1.E<<"\n";
    //std::cout<<"magnetic error: "<<std::sqrt(L1.B*L1.B) <<"\n";
