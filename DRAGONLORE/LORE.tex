...
This chapter covers configuring, building, and running DRAGON itself. For turning simulation output into plots once a run has completed, see \Cref{chap:gaze}.
...
echo "bin/" >> .gitignore
\end{lstlisting}
The second line ensures that your compiled executables don't get committed to the repository.
