...
Each of the fallback cases will also pass \cpp{Config::fallback_limit} as the threshold to \cpp{DRAGONWING::reportFallback}. 
...
\begin{itemize}
\item Added counter (\Cref{sec:atomics}) which triggers step restart after too many fallbacks behaviours have occurred in a step.
...
\item Removed \cpp{Grid::on_step_fail}
\end{itemize}
\end{itemize} 
