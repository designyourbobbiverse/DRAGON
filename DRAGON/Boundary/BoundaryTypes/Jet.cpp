...
//MARK: Constructors
Boundary::Jet::Jet(double rho, double v, double p, double r, int face): rho(rho), v(v), p(p), rj(r), jetface(face), GhostFill(0, true){ }
Boundary::Jet::Jet(double rho, double v, double p, double r, std::string face): Jet(rho,v,p,r, face_mask(face)){ }

//MARK: 1D
//All applicable ghost cells are set to equal this->state
void Boundary::Jet::apply(Grid1D& grid) {
