...
#include "Hydro/Grid.hpp" //For various data types

namespace DRAGON::Godunov{

//1D
void sweep(FluidArray1D& w, double dt_dx, PassiveArray1D& q);
...
void halfStateSources(FluidArray2D& _L, const Grid2D& _W,  FluidArray2D& _R, double dt_2);
...
void applyFluxes(const FluidArray2D& w, FluidArray2D& _w, const FluxArray2D& F_X, const FluxArray2D& F_Y,  const Source::SourceTerm& source,  const FluidArray2D& wref, double dt_dx, double dt_dy, double dt, int g=0);
...
void halfStateSources(FluidArray3D& _L, const Grid3D& _W,  FluidArray3D& _R, double dt_2);
...
void applyFluxes(const FluidArray3D& w, FluidArray3D& _w, const FluxArray3D& F_X, const FluxArray3D& F_Y, const FluxArray3D& F_Z,  const Source::SourceTerm& source, const FluidArray3D& wref, double dt_dx, double dt_dy, double dt_dz, double dt, int g=0);


//3DCTU
#ifdef MHD
void ctu_sweep_MHD(FluidArray3D& _xL, FluidArray3D& _xR, FluidArray3D& _yL, FluidArray3D& _yR, FluidArray3D& _zL, FluidArray3D& _zR, const FluxArray3D& F_X, const FluxArray3D& F_Y, const FluxArray3D& F_Z, const MagneticArray3D& Ehalf, const MagneticArray3D &Bhalf,   const FluidArray3D& w0, const MagneticArray3D &B0, double dt_dx, double dt_dy, double dt_dz);
#else
void ctu_sweep_hydro(FluidArray3D& _xL, FluidArray3D& _xR, FluidArray3D& _yL, FluidArray3D& _yR, FluidArray3D& _zL, FluidArray3D& _zR, FluxArray3D& F_X, FluxArray3D& F_Y, FluxArray3D& F_Z, double dt_dx, double dt_dy, double dt_dz);
